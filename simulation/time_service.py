...
class TimeService(sims4.service_manager.Service):
    ...
    MAX_TIME_SLICE_MILLISECONDS = sims4.tuning.tunable.OptionalTunable(
        description=
        ...
        tunable=sims4.tuning.tunable.Tunable(
            description=
    ...
    def _on_exception(self, timeline, element, exception, message):
        ...
        logger.callstack('The enclosing callstack follows',
