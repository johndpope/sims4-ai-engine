...
class TestProgram(object):
    ...
    def parseArgs(self, argv):
        if len(argv) > 1 and argv[1].lower() == 'discover' or len(argv) == 1 and self.module is None:
    ...
    def _getOptParser(self):
        ...
        parser.add_option('-q', '--quiet', dest='quiet', default=False, help='Quiet output', action='store_true')
        if self.failfast != False:
