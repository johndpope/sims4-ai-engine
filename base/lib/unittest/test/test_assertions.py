...
class TestLongMessage(unittest.TestCase):
    __qualname__ = 'TestLongMessage'

    def setUp(self):

        class TestableTestFalse(unittest.TestCase):
            __qualname__ = 'TestLongMessage.setUp.<locals>.TestableTestFalse'
            longMessage = False
        ...
        class TestableTestTrue(unittest.TestCase):
            __qualname__ = 'TestLongMessage.setUp.<locals>.TestableTestTrue'
            longMessage = True
            failureException = self.failureException
    ...
    def assertMessagesCM(self, methodName, args, func, errors):
        ...
        for ((cls, kwargs), err) in zip(p, errors):
            ...
            with self.assertRaisesRegex(cls.failureException, err), method(*args, **kwargs) as cm:
                func()
