...
from unittest.mock import NonCallableMock, CallableMixin, patch, sentinel, MagicMock, Mock, NonCallableMagicMock, patch, _patch, DEFAULT, call, _get_target
...
def _get_proxy(obj, get_only=True):
    ...
    class Proxy(object):
        __qualname__ = '_get_proxy.<locals>.Proxy'
...
class PatchTest(unittest.TestCase):
    ...
    def test_single_patchobject(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_single_patchobject.<locals>.Something'
    ...
    def test_patchobject_with_none(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_patchobject_with_none.<locals>.Something'
            attribute = sentinel.Original
    ...
    def test_multiple_patchobject(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_multiple_patchobject.<locals>.Something'
            attribute = sentinel.Original
    ...
    def test_patchobject_with_default_mock(self):
        ...
        class Test(object):
            __qualname__ = 'PatchTest.test_patchobject_with_default_mock.<locals>.Test'
    ...
    def test_patch_with_static_methods(self):
        ...
        class Foo(object):
            __qualname__ = 'PatchTest.test_patch_with_static_methods.<locals>.Foo'
    ...
    def test_patch_slots(self):
        ...
        class Foo(object):
            __qualname__ = 'PatchTest.test_patch_slots.<locals>.Foo'
            __slots__ = ('Foo',)
    ...
    def test_patchobject_class_decorator(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_patchobject_class_decorator.<locals>.Something'
            attribute = sentinel.Original

        class Foo(object):
            __qualname__ = 'PatchTest.test_patchobject_class_decorator.<locals>.Foo'
    ...
    def test_patch_class_decorator(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_patch_class_decorator.<locals>.Something'
            attribute = sentinel.Original

        class Foo(object):
            __qualname__ = 'PatchTest.test_patch_class_decorator.<locals>.Foo'
    ...
    def test_patchobject_twice(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_patchobject_twice.<locals>.Something'
            attribute = sentinel.Original
            next_attribute = sentinel.Original2
    ...
    def test_patch_descriptor(self):
        ...
        class Nothing(object):
            __qualname__ = 'PatchTest.test_patch_descriptor.<locals>.Nothing'
            foo = None

        class Something(object):
            __qualname__ = 'PatchTest.test_patch_descriptor.<locals>.Something'
            foo = {}
    ...
    def test_patch_dict_class_decorator(self):
        ...
        class Test(object):
            __qualname__ = 'PatchTest.test_patch_dict_class_decorator.<locals>.Test'
    ...
    def test_get_only_proxy(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_get_only_proxy.<locals>.Something'
            foo = 'foo'

        class SomethingElse:
            __qualname__ = 'PatchTest.test_get_only_proxy.<locals>.SomethingElse'
            foo = 'foo'
    ...
    def test_get_set_delete_proxy(self):
        ...
        class Something(object):
            __qualname__ = 'PatchTest.test_get_set_delete_proxy.<locals>.Something'
            foo = 'foo'

        class SomethingElse:
            __qualname__ = 'PatchTest.test_get_set_delete_proxy.<locals>.SomethingElse'
            foo = 'foo'
    ...
    def test_autospec(self):
        ...
        class Boo(object):
            __qualname__ = 'PatchTest.test_autospec.<locals>.Boo'
            ...
            class Bar(object):
                __qualname__ = 'PatchTest.test_autospec.<locals>.Boo.Bar'
    ...
    def test_autospec_with_object(self):
        ...
        class Bar(Foo):
            __qualname__ = 'PatchTest.test_autospec_with_object.<locals>.Bar'
            extra = []
    ...
    def test_new_callable_keyword_arguments(self):
        ...
        class Bar(object):
            __qualname__ = 'PatchTest.test_new_callable_keyword_arguments.<locals>.Bar'
            kwargs = None
    ...
    def test_new_callable_spec(self):
        ...
        class Bar(object):
            __qualname__ = 'PatchTest.test_new_callable_spec.<locals>.Bar'
            kwargs = None
    ...
    def test_new_callable_inherit_for_mocks(self):
        ...
        class MockSub(Mock):
            __qualname__ = 'PatchTest.test_new_callable_inherit_for_mocks.<locals>.MockSub'
    ...
    def test_new_callable_inherit_non_mock(self):
        ...
        class NotAMock(object):
            __qualname__ = 'PatchTest.test_new_callable_inherit_non_mock.<locals>.NotAMock'
    ...
    def test_new_callable_class_decorating(self):
        ...
        class SomeTest(object):
            __qualname__ = 'PatchTest.test_new_callable_class_decorating.<locals>.SomeTest'
    ...
    def test_patch_multiple_decorating_class(self):
        ...
        class SomeTest(object):
            __qualname__ = 'PatchTest.test_patch_multiple_decorating_class.<locals>.SomeTest'
    ...
    def test_patch_multiple_new_callable(self):
        ...
        class Thing(object):
            __qualname__ = 'PatchTest.test_patch_multiple_new_callable.<locals>.Thing'
    ...
    def test_patch_test_prefix(self):
        ...
        class Foo(object):
            __qualname__ = 'PatchTest.test_patch_test_prefix.<locals>.Foo'
            thing = 'original'
    ...
    def test_patch_dict_test_prefix(self):
        ...
        class Foo(object):
            __qualname__ = 'PatchTest.test_patch_dict_test_prefix.<locals>.Foo'
    ...
    def test_patch_propogrates_exc_on_exit(self):
        ...
        class holder:
            __qualname__ = 'PatchTest.test_patch_propogrates_exc_on_exit.<locals>.holder'
            exc_info = (None, None, None)

        class custom_patch(_patch):
            __qualname__ = 'PatchTest.test_patch_propogrates_exc_on_exit.<locals>.custom_patch'
