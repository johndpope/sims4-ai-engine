...
class MockTest(unittest.TestCase):
    ...
    def test_repr_with_spec(self):
        ...
        class X(object):
            __qualname__ = 'MockTest.test_repr_with_spec.<locals>.X'
    ...
    def test_from_spec(self):
        ...
        class Something(object):
            __qualname__ = 'MockTest.test_from_spec.<locals>.Something'
            x = 3
            __something__ = None
    ...
    def test_wraps_attributes(self):
        ...
        class Real(object):
            __qualname__ = 'MockTest.test_wraps_attributes.<locals>.Real'
            attribute = Mock()
    ...
    def test_spec_class(self):
        ...
        class X(object):
            __qualname__ = 'MockTest.test_spec_class.<locals>.X'
    ...
    def test_subclass_with_properties(self):
        ...
        class SubClass(Mock):
            __qualname__ = 'MockTest.test_subclass_with_properties.<locals>.SubClass'
    ...
    def test_side_effect_iterator(self):
        ...
        class Foo(object):
            __qualname__ = 'MockTest.test_side_effect_iterator.<locals>.Foo'
