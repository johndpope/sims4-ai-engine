...
class ParserBase:
    ...
    def parse_declaration(self, i):
        ...
        while j < n:
            ...
            if c in '"\'':
                ...
                elif decltype in frozenset({'element', 'linktype', 'link', 'attlist'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            return j
        if sectName in frozenset({'include', 'cdata', 'rcdata', 'temp', 'ignore'}):
            match = _markedsectionclose.search(rawdata, i + 3)
        elif sectName in frozenset({'endif', 'if', 'else'}):
