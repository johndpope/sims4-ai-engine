...
class DecimalException(ArithmeticError):
    __qualname__ = 'DecimalException'

    def handle(self, context, *args):
        pass

class Clamped(DecimalException):
    __qualname__ = 'Clamped'

class InvalidOperation(DecimalException):
    __qualname__ = 'InvalidOperation'
...
class ConversionSyntax(InvalidOperation):
    __qualname__ = 'ConversionSyntax'

    def handle(self, context, *args):
        return _NaN

class DivisionByZero(DecimalException, ZeroDivisionError):
    __qualname__ = 'DivisionByZero'

    def handle(self, context, sign, *args):
        return _SignedInfinity[sign]

class DivisionImpossible(InvalidOperation):
    __qualname__ = 'DivisionImpossible'

    def handle(self, context, *args):
        return _NaN

class DivisionUndefined(InvalidOperation, ZeroDivisionError):
    __qualname__ = 'DivisionUndefined'

    def handle(self, context, *args):
        return _NaN

class Inexact(DecimalException):
    __qualname__ = 'Inexact'

class InvalidContext(InvalidOperation):
    __qualname__ = 'InvalidContext'

    def handle(self, context, *args):
        return _NaN

class Rounded(DecimalException):
    __qualname__ = 'Rounded'

class Subnormal(DecimalException):
    __qualname__ = 'Subnormal'

class Overflow(Inexact, Rounded):
    __qualname__ = 'Overflow'
...
class Underflow(Inexact, Rounded, Subnormal):
    __qualname__ = 'Underflow'

class FloatOperation(DecimalException, TypeError):
    __qualname__ = 'FloatOperation'
...
class Decimal(object):
    ...
    def _compare_check_nans(self, other, context):
        ...
        if (self._is_special or other._is_special) and other.is_qnan():
    ...
    def __pow__(self, other, modulo=None, context=None):
        ...
        if exact and not other._isinteger():
            ...
            for exception in (Underflow, Subnormal, Inexact, Rounded, Clamped):
                while newcontext.flags[exception]:
...
def _ilog(x, M, L=8):
    ...
    R = 0
    while R <= L:
        while abs(y) << L - R >= M or R > L and abs(y) >> R - L >= M:
...
def _parse_format_specifier(format_spec, _localeconv=None):
    ...
    if format_dict['zeropad'] and align is not None:
    ...
    if format_dict['precision'] == 0 and (format_dict['type'] is None or format_dict['type'] in 'gGn'):
