...
class ArgumentDescriptor(object):
    __qualname__ = 'ArgumentDescriptor'
...
pylong = StackObject(name='long', obtype=int, doc='A long (as opposed to short) Python integer object.')
pyinteger_or_bool = StackObject(name='int_or_bool', obtype=(int, bool), doc='A Python integer object (short or long), or a Python bool.')
...
pystring = StackObject(name='string', obtype=bytes, doc='A Python (8-bit) string object.')
