...
class AbstractFormatter:
    __qualname__ = 'AbstractFormatter'
    ...
    def add_flowing_data(self, data):
        ...
        if not data:
            if not self.nospace:
                ...
                self.parskip = 0
            return
        if not ((prespace or self.softspace) and self.nospace):
            data = ' ' + data
