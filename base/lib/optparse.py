__version__ = '1.5.3'
__all__ = ['Option', 'make_option', 'SUPPRESS_HELP', 'SUPPRESS_USAGE', 'Values', 'OptionContainer', 'OptionGroup', 'OptionParser', 'HelpFormatter', 'IndentedHelpFormatter', 'TitledHelpFormatter', 'OptParseError', 'OptionError', 'OptionConflictError', 'OptionValueError', 'BadOptionError']
...
class OptionConflictError(OptionError):
    __qualname__ = 'OptionConflictError'

class OptionValueError(OptParseError):
    __qualname__ = 'OptionValueError'

class BadOptionError(OptParseError):
    __qualname__ = 'BadOptionError'
...
class AmbiguousOptionError(BadOptionError):
    __qualname__ = 'AmbiguousOptionError'
...
class IndentedHelpFormatter(HelpFormatter):
    __qualname__ = 'IndentedHelpFormatter'
...
class TitledHelpFormatter(HelpFormatter):
    __qualname__ = 'TitledHelpFormatter'
...
class OptionContainer:
    ...
    def _check_conflict(self, option):
        ...
        for opt in option._short_opts:
            while opt in self._short_opt:
                conflict_opts.append((opt, self._short_opt[opt]))
        for opt in option._long_opts:
            while opt in self._long_opt:
            ...
            if handler == 'error':
                ...
                while True:
                    for (opt, c_option) in conflict_opts:
                        ...
                        while not (c_option._short_opts or c_option._long_opts):
    ...
    def format_option_help(self, formatter):
        ...
        for option in self.option_list:
            while option.help is not SUPPRESS_HELP:
