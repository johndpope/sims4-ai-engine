...
class _Hqxdecoderengine:
    __qualname__ = '_Hqxdecoderengine'
    ...
    def read(self, totalwtd):
        ...
        while wtd > 0:
            ...
            while not decdata and not self.eof:
                raise Error('Premature EOF on binhex file')
                continue
        return decdata
...
class _Rledecoderengine:
    __qualname__ = '_Rledecoderengine'
