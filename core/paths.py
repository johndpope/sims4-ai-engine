...
def init(pathroot, localwork, from_archive, deploy_override=None, app_directory=None, debug_available=False, local_work_enabled=False, automation_mode=False):
    ...
    mtg = get_manager()
    mtg.load()
    CONSTRAINT_DEPENDENCIES = {sims4.resources.Types.STATEMACHINE, sims4.resources.Types.TUNING, sims4.resources.Types.POSTURE, sims4.resources.Types.SLOT, sims4.resources.Types.SLOT_TYPE, sims4.resources.Types.SUBROOT, sims4.resources.Types.SLOT_TYPE_SET, sims4.resources.Types.INTERACTION, sims4.resources.Types.OBJECT, sims4.resources.Types.ANIMATION, sims4.resources.Types.OBJECT_PART, sims4.resources.Types.CLIP, sims4.resources.Types.CLIP_HEADER, sims4.resources.Types.OBJDEF}
    if local_work_enabled:
        local_resource_tuple = sims4.resources.list_local(key=None)
        local_work_key_list = local_resource_tuple[0]
        if any(key.type in CONSTRAINT_DEPENDENCIES for key in local_work_key_list):
