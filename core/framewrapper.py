...
IS_ABOVE_PY25 = False
try:
    while sys.version_info[0] == 3 or sys.version_info[
            0] == 2 and sys.version_info[1] >= 5:
        IS_ABOVE_PY25 = True
...
if IS_ABOVE_PY25 and HAS_CTYPES:
    ...
    _frame_wrapper_fields = [('_base_', PyObjectHeadWrapperVar),
    ...
    _frame_wrapper_fields += [
        ('f_builtins', ctypes.py_object), ('f_globals', ctypes.py_object),
        ('f_locals', ctypes.py_object),
        ('f_valuestack', ctypes.POINTER(ctypes.c_void_p)),
        ('f_stacktop', ctypes.POINTER(ctypes.c_void_p)),
        ('f_trace', ctypes.c_void_p), ('f_exc_type', ctypes.c_void_p),
        ('f_exc_value', ctypes.c_void_p), ('f_exc_traceback', ctypes.c_void_p),
        ('f_tstate', ctypes.c_void_p), ('f_lasti', ctypes.c_int),
        ('f_lineno', ctypes.c_int), ('f_iblock', ctypes.c_int),
...
if 'FrameWrapper' in globals():
    ...
    def save_locals(locals_dict, frame):
        ...
        frame_wrapper = ctypes.cast(frame_pointer,
                                    ctypes.POINTER(FrameWrapper))
